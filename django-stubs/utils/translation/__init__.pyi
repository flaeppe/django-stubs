...
def ngettext_lazy(singular: str, plural: str, number: Union[int, str, None] = ...) -> StrPromise: ...
def npgettext_lazy(context: str, singular: str, plural: str, number: Union[int, str, None] = ...) -> StrPromise: ...
